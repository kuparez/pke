...
class TopicalPageRank(SingleRank):
    ...
    def candidate_weighting(
        ...
        if lda_model is None:
            if six.PY2:
                lda_model = os.path.join(self._models, "lda-1000-semeval2010.py2.pickle.gz")
            else:
        ...
        w = nx.pagerank(G=self.graph, personalization=W, alpha=0.85, tol=0.0001, weight="weight")
